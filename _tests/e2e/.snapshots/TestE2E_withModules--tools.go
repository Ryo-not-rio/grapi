...
//go:generate go build -v -o=./bin/grapi github.com/Ryo-not-rio/grapi/cmd/grapi
//go:generate go build -v -o=./bin/grapi-gen-command github.com/Ryo-not-rio/grapi/cmd/grapi-gen-command
//go:generate go build -v -o=./bin/grapi-gen-scaffold-service github.com/Ryo-not-rio/grapi/cmd/grapi-gen-scaffold-service
//go:generate go build -v -o=./bin/grapi-gen-service github.com/Ryo-not-rio/grapi/cmd/grapi-gen-service
//go:generate go build -v -o=./bin/grapi-gen-type github.com/Ryo-not-rio/grapi/cmd/grapi-gen-type
